...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LPARENTHESES = 5,               /* LPARENTHESES  */
  YYSYMBOL_RPARENTHESES = 6,               /* RPARENTHESES  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ROOT", "NODE",
  "LPARENTHESES", "RPARENTHESES", "LBRACKET", "RBRACKET", "COMMA",
  "STRING", "$accept", "S", "N", "L", "LL", YY_NULLPTR
};
...
{
      15,     5,    16,     1,     2,    19,    20,     6,     7,     9,
      11,    10,    12,    13,     8,    18,     0,    21
};

static const yytype_int8 yycheck[] =
{
       8,     5,    10,     3,     4,     8,     9,     5,     0,    10,
       6,    10,     9,     7,     4,     6,    -1,    10
};
...
{
       0,     3,     4,    12,    13,     5,     5,     0,    12,    10,
      10,     6,     9,     7,    14,     8,    10,    15,     6,     8,
       9,    10
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* N: ROOT LPARENTHESES STRING RPARENTHESES  */
#line 69 "tree.y"
    {
        rootPtr = nodeStore.get(*(yyvsp[-1].strPtr_));
        delete (yyvsp[-1].strPtr_);
    }
#line 1118 "tree.tab.c"
    break;

  case 5: /* N: NODE LPARENTHESES STRING COMMA L RPARENTHESES  */
#line 76 "tree.y"
    {
        Node* newNode = new Node(*(yyvsp[-3].strPtr_), (yyvsp[-1].stringDsPtr_));
        nodeStore.put(newNode);
        delete (yyvsp[-3].strPtr_);
    }
#line 1128 "tree.tab.c"
    break;

  case 6: /* L: LBRACKET RBRACKET  */
#line 84 "tree.y"
    {
        (yyval.stringDsPtr_) = createNewStringDsPtr();
    }
#line 1136 "tree.tab.c"
    break;

  case 7: /* L: LBRACKET LL RBRACKET  */
#line 90 "tree.y"
    {
        (yyval.stringDsPtr_) = (yyvsp[-1].stringDsPtr_);
    }
#line 1144 "tree.tab.c"
    break;
...
#line 96 "tree.y"
    {
        (yyval.stringDsPtr_) = createNewStringDsPtr();
        (yyval.stringDsPtr_)->push_back(*(yyvsp[0].strPtr_));
        delete (yyvsp[0].strPtr_);
    }
#line 1154 "tree.tab.c"
    break;

  case 9: /* LL: LL COMMA STRING  */
#line 104 "tree.y"
    {
        (yyval.stringDsPtr_) = (yyvsp[-2].stringDsPtr_);
        (yyval.stringDsPtr_)->push_back(*(yyvsp[0].strPtr_));
        delete (yyvsp[0].strPtr_);
    }
#line 1164 "tree.tab.c"
    break;


#line 1168 "tree.tab.c"
